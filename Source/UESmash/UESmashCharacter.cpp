...
void AUESmashCharacter::DoMove(float Right, float Forward)
{
...
void AUESmashCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AUESmashCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AUESmashCharacter::DoJumpEnd()
{
